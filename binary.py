...
def bin(n): 
    ...
    N = n    
    #while untuk kejadian terus menerus sedangkan if untuk kejadian sekali saja, ketika kejadian N selalu lebih besar dari 0    maka perintah selanjutnya akan terus berulang
    while N > 0:
